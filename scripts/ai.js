...
var AI = function() {
	...
	/*
	 * private recursive function that computes the minimax value of a game
	 * state @param state [State] : the state to calculate its minimax value
	...
	// public function: notify the ai player that it's its turn @param turn
	// [String]: the player to play, either X or O
